                            ...
                            <tbody>
                                ...
                                foreach ($tanding as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('tanding/delTanding/' . $row->id_tanding) ?>" class="btn btn-sm btn-danger tombol-hapus">Hapus</a>
                                            <a href="<?= base_url('tanding/detail/' . $row->id_tanding) ?>" class="btn btn-sm btn-info">Detail</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
...
<div class="modal fade" id="tambahPeserta" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('tanding/tandingAdd') ?>" method="post" class="forms-sample" enctype="multipart/form-data">
